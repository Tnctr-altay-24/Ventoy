...
int ventoy_fill_data(grub_uint32_t buflen, char *buffer)
{
    ...
    const char tnctr[]={ 0x20, 0x20, 0x77, 0x77, 0x77, 0x2E, 0x61, 0x4C, 0x54, 0x61, 0x79, 0xE2, 0x84, 0xA2, 0x2E, 0x6E, 0x65, 0x74, 0x00 }; 
...
static grub_err_t ventoy_cmd_show_secondary_menu(grub_extcmd_context_t ctxt, int argc, char **args)
{
    ...
    vtoy_dummy_menuentry(cmd, pos, len, "$VTLANG_FILE_CHKSUM \\\"$vt_chosen_name\\\"", "second_checksum"); seldata[n++] = 5;
